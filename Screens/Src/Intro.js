...
import { StyleSheet, Text, View, Dimensions,StatusBar,SafeAreaView,ScrollView, PixelRatio ,Image} from 'react-native'
        ...
        <SafeAreaView style={{ flex: 1 }}>
          ...
          >
            <View style={{ width, height }}>
              <Image source={require('./assets/1.png')} style={styles.imageStyle} />
